package com.alix.tsuki.suggestions.ui
...
import com.alix.tsuki.core.exceptions.CloudFlareException
import com.alix.tsuki.core.exceptions.resolve.CaptchaHandler
import com.alix.tsuki.core.model.distinctById
...
import com.alix.tsuki.core.util.LocaleComparator
import com.alix.tsuki.core.util.ext.asArrayList
import com.alix.tsuki.core.util.ext.awaitUniqueWorkInfoByName
import com.alix.tsuki.core.util.ext.awaitWorkInfosByTag
import com.alix.tsuki.core.util.ext.checkNotificationPermission
import com.alix.tsuki.core.util.ext.flatten
...
import com.alix.tsuki.core.util.ext.sanitize
import com.alix.tsuki.core.util.ext.takeMostFrequent
import com.alix.tsuki.core.util.ext.toBitmapOrNull
import com.alix.tsuki.core.util.ext.trySetForeground
...
import com.alix.tsuki.settings.work.PeriodicWorkScheduler
import com.alix.tsuki.suggestions.domain.MangaSuggestion
import com.alix.tsuki.suggestions.domain.SuggestionRepository
import com.alix.tsuki.suggestions.domain.TagsBlacklist
...
class SuggestionsWorker @AssistedInject constructor(
	...
	private companion object {
		...
		const val GROUP_SUGGESTION = "com.alix.tsuki.SUGGESTIONS"
