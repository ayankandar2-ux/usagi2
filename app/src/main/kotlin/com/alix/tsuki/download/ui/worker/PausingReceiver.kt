...
import com.alix.tsuki.core.util.ext.toUUIDOrNull
...
class PausingReceiver(
	...
	companion object {
		...
		private const val ACTION_PAUSE = "com.alix.tsuki.download.PAUSE"
		private const val ACTION_RESUME = "com.alix.tsuki.download.RESUME"
		private const val ACTION_SKIP = "com.alix.tsuki.download.SKIP"
		private const val ACTION_SKIP_ALL = "com.alix.tsuki.download.SKIP_ALL"
