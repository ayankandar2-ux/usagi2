...
import com.alix.tsuki.core.exceptions.BadBackupFormatException
import com.alix.tsuki.core.exceptions.CaughtException
import com.alix.tsuki.core.exceptions.CloudFlareBlockedException
...
import com.alix.tsuki.core.exceptions.EmptyMangaException
import com.alix.tsuki.core.exceptions.IncompatiblePluginException
import com.alix.tsuki.core.exceptions.InteractiveActionRequiredException
import com.alix.tsuki.core.exceptions.NoDataReceivedException
import com.alix.tsuki.core.exceptions.NonFileUriException
import com.alix.tsuki.core.exceptions.ProxyConfigException
import com.alix.tsuki.core.exceptions.SyncApiException
import com.alix.tsuki.core.exceptions.UnsupportedFileException
import com.alix.tsuki.core.exceptions.UnsupportedSourceException
import com.alix.tsuki.core.exceptions.WrapperIOException
...
fun FileNotFoundException.parseMessage(resources: Resources): String? {
    ...
    /storage/0000-0000/Android/media/d1f08350-0c25-460b-8f50-008e49de3873.jpg.tmp: open failed: EROFS (Read-only file system)
     /storage/emulated/0/Android/data/com.alix.tsuki/cache/pages/fe06e192fa371e55918980f7a24c91ea.jpg: open failed: ENOENT (No such file or directory)
     /storage/0000-0000/Android/data/com.alix.tsuki/files/manga/e57d3af4-216e-48b2-8432-1541d58eea1e.tmp (I/O error)
     */
    val groups = FNFE_MESSAGE_REGEX.matchEntire(message ?: return null)?.groupValues ?: return null
