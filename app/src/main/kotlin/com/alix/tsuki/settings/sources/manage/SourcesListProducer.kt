package com.alix.tsuki.settings.sources.manage
...
import com.alix.tsuki.core.db.TABLE_SOURCES
...
class SourcesListProducer @Inject constructor(
	...
	private suspend fun buildList(): List<SourceConfigItem> {
		val enabledSources = repository.getEnabledSources().filter {
            ...
            unwrapped !is com.alix.tsuki.core.parser.external.ExternalMangaSource &&
            unwrapped !is org.draken.tsukimix.core.parser.tachiyomi.model.TachiyomiMangaSource &&
            unwrapped !is com.alix.tsuki.core.model.LocalMangaSource &&
            unwrapped !is com.alix.tsuki.core.model.TestMangaSource &&
            unwrapped !is com.alix.tsuki.core.model.UnknownMangaSource
        }
